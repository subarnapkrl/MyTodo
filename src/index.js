    ...
    if (button.id === "new-todo") {
      ...
      expandToDo(
        document
          ...
          .querySelector(`[data-index="${button.getAttribute("data-index")}"]`)
      );
      ...
      showToDoForm(
        content,
        "Edit",
        projectsList[projectIndex].todos[button.getAttribute("data-index")]
          .title,
        projectsList[projectIndex].todos[button.getAttribute("data-index")]
          .description,
        projectsList[projectIndex].todos[button.getAttribute("data-index")]
      ...
      form.onsubmit = (submission) => {
        ...
        updateProjectName(
          document.querySelector("#project-top-row").querySelector("h2"),
          projectsList[projectIndex].name
        );
